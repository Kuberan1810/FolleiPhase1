...
const NotifySalesDrawer: React.FC<NotifySalesDrawerProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className={`fixed top-16 right-0 h-[calc(100vh-64px)] w-[379px] bg-white z-[40] transform transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0 shadow-2xl' : 'translate-x-full shadow-none'}`}>
