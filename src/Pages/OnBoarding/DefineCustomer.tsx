        ...
        <div className="min-h-screen bg-[#F7F9FB] flex flex-col items-center justify-center p-4 sm:p-6 font-sans">
            <div className="w-full max-w-[845px] flex flex-col items-center">
                ...
                <div className="text-center mb-8">
                    <span className="text-[12px] font-medium uppercase tracking-widest text-[#444748] block mb-1">
                        STEP 3 OF 3
                    </span>
                    <h1 className="text-[32px] font-bold text-[#191C1E] tracking-tight">
                                ...
                                >
                                    ...
                                    <div>
                                        <div className="flex items-center justify-between mb-4">
                                            <div
                                                className={`w-9 h-9 rounded-xl flex items-center justify-center transition-colors ${isSelected ? 'bg-[#004370] text-white' : 'bg-[#EDEEF0] text-[#444748]'
                                                    }`}
                                            >
                                        ...
                                        <span className="text-[10px] font-bold uppercase tracking-wider text-[#444748] block mt-0.5">
                                            {option.subtitle}
                                        </span>
                                    ...
                                    {option.examples && option.examples.length > 0 && (
                                        <div className="mt-5 pt-4 border-t border-[#EDEEF0]">
                                            <span className="text-[10px] font-bold uppercase tracking-wider text-[#444748] block mb-2">
                                                EXAMPLES
                                            </span>
                ...
                <div className="flex items-center justify-center gap-2 mt-8">
                    <span className="w-2 h-2 bg-[#EDEEF0] rounded-full transition-all" />
                    <span className="w-2 h-2 bg-[#EDEEF0] rounded-full transition-all" />
                    <span className="w-2.5 h-2.5 bg-[#191C1E] rounded-full transition-all" />
                </div>
            </div>
        </div>
    );
