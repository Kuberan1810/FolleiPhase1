          ...
          <div className="flex justify-between gap-3 sm:gap-4 mb-[32px]">
            {[...Array(6)].map((_, i) => (
              <input
                ...
                type="text"
                maxLength={1}
                className="w-10 h-14 sm:w-[68px] sm:h-[72px] rounded-[10px] border border-[#D2D2D2] bg-white text-center text-[28px] font-bold focus:outline-none focus:ring-2 focus:ring-[#0C4A6E] transition-all"
              />
            ))}
          </div>
