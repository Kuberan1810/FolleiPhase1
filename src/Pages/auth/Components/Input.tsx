  ...
  return (
    <div className={`w-full ${containerClassName}`}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          type={inputType}
          className={`w-full p-3.5 border border-[#C4C7C7] rounded-lg text-sm text-[#191C1E] placeholder:text-[#717378] bg-white selection:bg-gray-200 selection:text-[#16171A] transition-all duration-200 outline-none focus:border-black focus:ring-black ${
            leftIcon ? 'pl-10' : ''
