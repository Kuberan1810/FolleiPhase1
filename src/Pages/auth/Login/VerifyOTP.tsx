                            ...
                            <div className="flex justify-between gap-3 mb-4">
                                {otp.map((digit, index) => (
                                    <input
                                        ...
                                        className="w-12 h-14 md:w-16 md:h-16 text-center text-2xl font-semibold border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#003E6B]/20 focus:border-[#003E6B] transition-all bg-white font-urbanist shadow-sm"
                                    />
                                ))}
                            </div>
