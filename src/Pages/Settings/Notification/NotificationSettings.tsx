...
const Toggle = ({ isOn, onToggle }: ToggleProps) => (
  <button
    onClick={onToggle}
    className={`w-[60px] h-[30px] rounded-full p-1 transition-colors duration-200 ease-in-out relative flex items-center ${
      isOn ? 'bg-[#004370]' : 'bg-[#004370]/20'
    }`}
  >
    <div
      className={`w-[22px] h-[22px] rounded-full shadow-sm transform transition-transform duration-200 ease-in-out ${
        isOn ? 'translate-x-[30px] bg-white' : 'translate-x-0 bg-[#004370]'
      }`}
    />
  </button>
);
      ...
      <div className="w-full space-y-6">
        <div className="flex flex-col items-start gap-3.5">
          ...
          <div className="space-y-[4.5px]">
            <span className="text-[12px] font-[700] text-[#004370] font-inter leading-[16px] tracking-[1.2px] uppercase">
              Intelligence Hub
            </span>
            <h1 className="text-[30px] font-[800] text-[#191C1E] font-manrope leading-[36px] tracking-[0px]">
              Notification
            </h1>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-[24px] p-6 space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <span className="text-[20px] font-[700] text-[#191C1E] font-inter leading-[28px] tracking-[-0.5px]">
                  Presales
                </span>
              </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <div className="flex flex-col gap-1">
                  <span className="text-[16px] font-[600] text-[#191C1E] font-inter leading-[24px] tracking-[0px]">calls</span>
                  <span className="text-[14px] font-[400] text-[#434655] font-inter leading-[20px] tracking-[0px]">
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col gap-1">
                  <span className="text-[16px] font-[600] text-[#191C1E] font-inter leading-[24px] tracking-[0px]">messages</span>
                  <span className="text-[14px] font-[400] text-[#434655] font-inter leading-[20px] tracking-[0px]">
              ...
              <div className="flex items-center justify-between">
                <div className="flex flex-col gap-1">
                  <span className="text-[16px] font-[600] text-[#191C1E] font-inter leading-[24px] tracking-[0px]">emails</span>
                  <span className="text-[14px] font-[400] text-[#434655] font-inter leading-[20px] tracking-[0px]">
          ...
          {/* Second Card */}
          <div className="bg-white rounded-[24px] p-6 space-y-8">
            {/* Outbound Header */}
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="flex items-center justify-center w-[36px] h-[36px] bg-[#004370]/10 rounded-lg text-[#004370]">
