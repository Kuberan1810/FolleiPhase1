  ...
  return (
    <div className="rounded-[15px] bg-white p-5 sm:p-6 border border-[#E5E7EB]">
      ...
      <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6">
        {/* Email */}
        <div>
          <span className="text-[14px] text-[#4B5563] block font-medium">Email</span>
          <span className="text-[14px] font-semibold text-[#222222] mt-0.5 block break-all">
        ...
        {/* Phone number */}
        <div>
          <span className="text-[14px] text-[#4B5563] block font-medium" >Phone number</span>
          <span className="text-[14px] font-semibold text-[#222222] mt-0.5 block break-all">
        ...
        <div className="sm:col-span-2">
          <span className="text-[14px] text-[#4B5563] block font-medium">Last Interaction</span>
          <span className="text-[14px] font-semibold text-[#222222] mt-0.5 block break-all">
