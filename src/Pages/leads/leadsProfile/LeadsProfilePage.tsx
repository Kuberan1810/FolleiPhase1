        ...
        <div className="flex-1 px-4 sm:px-8 pb-12 py-6 lg:py-8 w-full max-w-7xl mx-auto space-y-6">
          ...
          <div className='flex  items-center  gap-2.5'>
            <button
              ...
              className="flex size-9 shrink-0 items-center justify-center rounded-xl border border-[#E5E7EB] bg-[#F9FAFB] text-[#475569] hover:bg-gray-100 hover:text-[#111827] transition-all cursor-pointer shadow-2xs mr-0.5"
            >

              <ArrowLeft className="size-4 stroke-[2.2]" />
            </button>
            <p className="text-[#464555] font-semibold">Back</p>
          </div>
          {/* Header Section */}
          <LeadProfileHeader
            lead={leadData}
