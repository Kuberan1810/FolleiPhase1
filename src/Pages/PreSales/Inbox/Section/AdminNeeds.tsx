    ...
    return (
        <div className="font-manrope animate-in fade-in slide-in-from-bottom-4 duration-500 pb-16">
            ...
            <div className="flex items-center gap-6 mb-6 px-1 relative">
                ...
                <div className="h-5 w-[2px] bg-[#94A3B8]/35 mx-1" />

                <div className="flex items-center gap-2">
                    <button className="flex items-center justify-center w-9 h-9 rounded-[8px] bg-[#EFF4FF] text-[#004370] cursor-pointer transition-colors border-none">
                        <List size={16} className="stroke-[2.5]" />
                    </button>
                    <button className="flex items-center justify-center w-9 h-9 text-[#434655] hover:bg-slate-50 cursor-pointer transition-colors border-none">
                        <AiOutlineAlignLeft size={16} className="stroke-[2] rotate-90" />
                    </button>
                </div>
            </div>
