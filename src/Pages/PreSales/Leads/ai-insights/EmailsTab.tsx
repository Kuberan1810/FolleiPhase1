    ...
    <div className="lg:col-span-2 bg-white rounded-[20px] border border-slate-200/60 p-6 shadow-[0_4px_20px_rgba(0,0,0,0.01)]">
      ...
      <div className="relative ml-2 py-2">
        <div className="relative pl-14 pb-8">
          ...
          <div className="w-[20px] h-[20px] rounded-full bg-[#15803D] flex items-center justify-center absolute left-[10px] top-0 text-white" />

          {/* Details Container */}
          <div className="flex flex-col border-[1px] border-[#C9DFFF] p-6 rounded-[12px]">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="flex items-center flex-wrap gap-2.5">
                <span className="font-bold text-[18px] text-[#0B1C30] font-inter">Email Opened</span>
            ...
            <div className="w-full rounded-[12px] bg-gradient-to-r from-[#4F46E5] via-[#EC4899] to-[#F97316] p-[1.5px] mt-4 shadow-[0_4px_20px_rgba(0,0,0,0.015)]">
              <div className="bg-white rounded-[10px] p-5">
                ...
                <p className="font-manrope font-normal text-[13px] leading-[20px] text-[#0B1C30] text-justify">
        ...
        <div className="relative pl-14">
          <div className="w-[20px] h-[20px] rounded-full bg-[#1a46bc] flex items-center justify-center absolute left-[10px] top-0 text-white" />
