...
const AttachmentsCard = () => {
    const files = [
        { icon: FileText, name: 'Enterprise_Proposal.pdf', size: '2.4 MB • PDF', color: 'text-[#EF4444]', bg: 'bg-[#EF444410]' },
        { icon: FileIcon, name: 'Requirements.docx', size: '1.1 MB • DOCX', color: 'text-[#3B82F6]', bg: 'bg-[#3B82F610]' },
