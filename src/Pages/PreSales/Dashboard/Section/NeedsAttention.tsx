...
const NeedsAttention: React.FC = () => {
  ...
  return (
    <div
      className="col-span-1 md:col-span-7 lg:col-span-7 BoxStyle flex flex-col gap-[15px] relative"
      style={{
    ...
    >
      <div className="flex justify-between items-center w-full">
        ...
        <BtnComSecondary label="View All" onClick={() => navigate("/presales/dashboard/needs-attention")} />
      </div>
      ...
      <div className="w-full bg-white border border-[#EDF3FD] rounded-[10px] overflow-hidden flex flex-col">
        ...
        <div className="flex-1">
          {attentionLeads.map((lead, idx) => (
            ...
            >
              <div className="col-span-2 sm:col-span-3 text-[16px] font-medium text-black leading-[1.2] tracking-[0.6px]">
                {lead.name}
              </div>
              <div className="col-span-4 sm:col-span-5 text-[16px] font-medium text-black leading-[1.2] tracking-[0.6px] truncate pr-2">
                {lead.issue}
              </div>
