          ...
          <div className="min-w-[600px] w-full flex flex-col">
            ...
            <div className="flex-1">
              {attentionLeads.map((lead, idx) => (
                ...
                >
                  <div className="col-span-3 text-[16px] font-medium text-black leading-[1.2] tracking-[0.6px] truncate pr-1">
                    {lead.name}
                  </div>
                  <div className="col-span-5 text-[16px] font-medium text-black leading-[1.2] tracking-[0.6px] truncate pr-2">
                    {lead.issue}
                  </div>
