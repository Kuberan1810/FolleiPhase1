...
export default function EngagementAll() {
  ...
  return (
    <div className="w-full" style={{ fontFamily: 'Manrope, sans-serif' }}>
      ...
      <div className="flex items-start justify-between mb-6 w-full">
        ...
        <div>
          <div className="flex items-center gap-3">
            ...
            >←</span>
            <h1 style={{
              fontFamily: 'Manrope', fontWeight: 700, fontSize: '32px',
          ...
          <div className="flex items-center gap-2 mt-1 ml-8">
            ...
            <span style={{
              fontFamily: 'Manrope', fontWeight: 400, fontSize: '12px',
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative" ref={filterRef}>
            ...
            >
              <span style={{ color: '#0F172A', fontSize: '14px', fontFamily: 'Manrope', fontWeight: 400 }}>Filter</span>
            ...
            {filterOpen && (
              <div className="absolute right-0 top-[38px] z-50 bg-white rounded-[16px] overflow-hidden"
                ...
                <div className="flex items-center justify-between px-5 pt-5 pb-4">
                  <span style={{ fontFamily:'Manrope', fontWeight:700, fontSize:'20px', lineHeight:'28px', color:'#0F172A' }}>
                    Filters
                  </span>
                  <span
                ...
                <div className="px-5 pb-4">
                  <div className="flex items-center gap-2 border border-[#E2E8F0] rounded-[8px] px-3 py-2">
                    ...
                    <input
                      ...
                      style={{ fontFamily:'Manrope', fontWeight:400, fontSize:'14px', lineHeight:'100%', color:'#0F172A' }}
                    />
                  </div>
                </div>
                ...
                <div className="px-5 py-4">
                  <div className="flex items-center justify-between mb-3">
                    <span style={{ fontFamily:'Manrope', fontWeight:600, fontSize:'14px', lineHeight:'20px', color:'#1E293B' }}>
                      Status
                    </span>
                    <span style={{ fontFamily:'Manrope', fontWeight:500, fontSize:'12px', lineHeight:'16px', color:'#64748B' }}>
                  ...
                  <div className="relative">
                    ...
                    >
                      {selectedStatuses.length === 0 && (
                        <span style={{ fontFamily:'Manrope', fontWeight:400, fontSize:'14px', color:'#94A3B8' }}>Select status...</span>
                      )}
                      {selectedStatuses.map(s => (
                        ...
                        >
                          <span style={{ fontFamily:'Manrope', fontWeight:500, fontSize:'12px', lineHeight:'19.5px', color:'#000000' }}>
                            {s}
                          </span>
                          <span
                      ...
                      <div className="absolute top-[100%] left-0 w-full z-10 mt-1 bg-white border border-[#E2E8F0] rounded-[8px] shadow-lg overflow-hidden">
                        {allStatuses.filter(s => !selectedStatuses.includes(s)).map(status => (
                          <div 
                            ...
                            style={{ fontFamily:'Manrope', fontWeight:400, fontSize:'14px', color:'#0F172A' }}
                            onClick={() => {
                        ...
                        {allStatuses.filter(s => !selectedStatuses.includes(s)).length === 0 && (
                          <div className="px-4 py-2 text-center" style={{ fontFamily:'Manrope', fontSize:'14px', color:'#94A3B8' }}>
                ...
                <div className="px-5 py-4">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    <span style={{ fontFamily:'Manrope', fontWeight:500, fontSize:'12px', lineHeight:'16px', color:'#0F172A' }}>
                ...
                <div className="flex items-center justify-between px-5 py-4">
                  <button
                    ...
                    style={{ fontFamily:'Manrope', fontWeight:500, fontSize:'14px', color:'#999999' }}
                    onClick={() => {
                      setSelectedStatuses([]);
      ...
      {/* ── TABLE ── */}
      <EngagementTable appliedFilters={appliedFilters} />
    </div>
  );
}
