  ...
  return (
    <div className="flex items-center gap-4 mt-6 rounded-[20px] overflow-hidden"
      ...
      <div className="flex-1" style={{ lineHeight: '29.25px' }}>
        <span style={{ fontWeight:500, fontSize:'18px', lineHeight:'29.25px', letterSpacing:'0.2px', color:'#131B2E' }}>
          Campaign performance is trending{' '}
        </span>
        <span style={{ fontWeight:500, fontSize:'18px', lineHeight:'29.25px', letterSpacing:'0.2px', color:'#10B981' }}>
          14.2% above expectations
        </span>
        <span style={{ fontWeight:500, fontSize:'18px', lineHeight:'29.25px', letterSpacing:'0.2px', color:'#131B2E' }}>
          . WhatsApp has emerged as the highest-converting channel with a{' '}
        </span>
        <span style={{ fontWeight:600, fontSize:'18px', lineHeight:'29.25px', letterSpacing:'0.2px', color:'#004370' }}>
          22% engagement rate
        </span>
        <span style={{ fontWeight:500, fontSize:'18px', lineHeight:'29.25px', letterSpacing:'0.2px', color:'#131B2E' }}>
          . Segment analysis confirms that{' '}
        </span>
        <span style={{ fontWeight:500, fontSize:'18px', lineHeight:'29.25px', letterSpacing:'0.2px', color:'#004370' }}>
          Returning Customers
        </span>
        <span style={{ fontWeight:500, fontSize:'18px', lineHeight:'29.25px', letterSpacing:'0.2px', color:'#131B2E' }}>
