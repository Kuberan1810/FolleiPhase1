...
const leads = [
  ...
  { id: 2, initials: 'EC', name: 'Ethan Carter', action: 'Read WhatsApp', cta: 'Requested Demo', ctaType: 'blue', rightLabel: 'POTENTIAL VALUE', rightValue: ',138K' },
  { id: 3, initials: 'ND', name: 'Noah Davis', action: 'Clicked Button', cta: null, ctaType: 'brochure', rightLabel: null, rightValue: null },
  { id: 4, initials: 'AJ', name: 'Ava Johnson', action: 'Read WhatsApp', cta: 'Requested Demo', ctaType: 'blue', rightLabel: 'POTENTIAL VALUE', rightValue: ',138K' },
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    {lead.cta && lead.ctaType !== 'brochure' && (
                      <>
                        <span style={{ color:'#464555' }}> &bull; </span>
                        <span style={{
