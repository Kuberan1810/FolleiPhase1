      ...
      <div className="p-4">
        <div className="flex items-center justify-between px-4 py-3 rounded-[16px]"
          ...
          <div className="flex flex-col gap-0.5">
            <span style={{ fontFamily:'Manrope', fontWeight:600, fontSize:'18px', lineHeight:'24px', color:'#131B2E' }}>
              Campaign Playback
            </span>
            <span style={{ fontFamily:'Inter', fontWeight:400, fontSize:'14px', lineHeight:'20px', color:'#464555' }}>
            ...
            <div className="rounded-[12px] overflow-hidden" style={{
              ...
              <div className="p-4 flex flex-col gap-3" style={{ backgroundColor: '#FFFFFF' }}>
                <div className="flex flex-col gap-1">
                  <span style={{ fontFamily:'Manrope', fontWeight:500, fontSize:'10px', lineHeight:'15px', letterSpacing:'1px', color:'#767587', textTransform:'uppercase' }}>
                    Subject
                  </span>
                  <span style={{ fontFamily:'Manrope', fontWeight:600, fontSize:'14px', lineHeight:'20px', color:'#131B2E' }}>
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="flex items-center gap-1 flex-wrap">
                    <span style={{ fontFamily:'Manrope', fontWeight:400, fontSize:'12px', lineHeight:'16px', color:'#464555' }}>
                      Don't miss out on the season's most anticipated drop.
                    </span>
                    <span className="px-1.5 py-0.5 rounded-[4px]" style={{
                      fontFamily:'Manrope', fontWeight:500, fontSize:'10.2px',
            ...
            <div className="relative w-full rounded-[24px] overflow-hidden"
              ...
              <div className="flex items-center gap-2 px-3 py-2 shrink-0" style={{ backgroundColor: '#075E54' }}>
                ...
                <div className="flex flex-col flex-1">
                  <span style={{ fontFamily:'Manrope', fontWeight:700, fontSize:'13px', lineHeight:'18px', color:'#FFFFFF' }}>
                    Follie ✓
                  </span>
                  <span style={{ fontFamily:'Manrope', fontWeight:400, fontSize:'11px', lineHeight:'14px', color:'#B2DFDB' }}>
                    Online
                  </span>
                </div>
              ...
              >
                ...
                <div className="flex justify-center">
                  <span className="px-3 py-0.5 rounded-full"
                    style={{ backgroundColor: '#D1F0E8', fontSize: '11px', fontFamily: 'Manrope', color: '#4A4A4A' }}>
                    TODAY
                  </span>
                </div>
                ...
                <div className="rounded-[12px] p-3 max-w-[85%]"
                  ...
                  <p style={{ fontFamily:'Manrope', fontWeight:400, fontSize:'13px', lineHeight:'20px', color:'#131B2E', margin: 0 }}>
                    Hey{' '}
                    <span className="px-1.5 py-0.5 rounded-[4px]" style={{
                      fontFamily:'Manrope', fontWeight:500, fontSize:'10.2px',
                      lineHeight:'16px', color:'#004370', backgroundColor:'#E1DFFF'
      ...
      <div className="flex items-center justify-between gap-3 mx-6 mb-6">
        {[
          ...
          <div key={metric.label}
            ...
            <span style={{ fontFamily:'Manrope', fontWeight:500, fontSize:'12px', lineHeight:'15px', color:'#464555', textAlign:'center' }}>
              {metric.label}
            </span>
            <span style={{ fontFamily:'Manrope', fontWeight:600, fontSize:'18px', lineHeight:'24px', color:'#131B2E', textAlign:'center' }}>
              {metric.value}
            </span>
          </div>
        ))}
