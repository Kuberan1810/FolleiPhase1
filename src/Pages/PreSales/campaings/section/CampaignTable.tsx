...
export default function CampaignTable() {
  ...
  const renderStatus = (status: string) => {
    switch (status) {
      case 'Active':
        return <span className="inline-flex items-center justify-center rounded-full px-3 py-1" style={{ backgroundColor: '#EFF6FF', color: '#2563EB', fontWeight: 700, fontSize: '14px', lineHeight: '20px' }}>Active</span>;
      case 'Completed':
        return <span className="inline-flex items-center justify-center rounded-full px-3 py-1" style={{ backgroundColor: '#EFFFF5', color: '#047C2E', fontWeight: 700, fontSize: '14px', lineHeight: '20px' }}>Completed</span>;
      case 'Paused':
        return <span className="inline-flex items-center justify-center rounded-full px-3 py-1" style={{ backgroundColor: '#FFEFEF', color: '#B91C1C', fontWeight: 700, fontSize: '14px', lineHeight: '20px' }}>Paused</span>;
      default:
        return null;
    }
  };
        ...
        <table className="w-full border-collapse">
          <thead>
            <tr className="bg-[#FAFBFF]">
              ...
              <th className="px-6 py-3 text-left" style={{ fontWeight: 600, fontSize: '12px', color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.5px', lineHeight: '20px' }}>CHANNEL</th>
              <th className="px-6 py-3 text-left" style={{ fontWeight: 600, fontSize: '12px', color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.5px', lineHeight: '20px' }}>STATUS</th>
              <th className="px-6 py-3 text-center" style={{ fontWeight: 600, fontSize: '12px', color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.5px', lineHeight: '20px' }}>SENT</th>
              <th className="px-6 py-3 text-center" style={{ fontWeight: 600, fontSize: '12px', color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.5px', lineHeight: '20px' }}>REPLIES</th>
              <th className="px-6 py-3 text-center" style={{ fontWeight: 600, fontSize: '12px', color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.5px', lineHeight: '20px' }}>CONVERTED</th>
              <th className="px-6 py-3 text-center" style={{ fontWeight: 600, fontSize: '12px', color: '#64748B', textTransform: 'uppercase', letterSpacing: '0.5px', lineHeight: '20px' }}>ACTION</th>
            </tr>
          </thead>
          <tbody>
            {campaigns.map((row) => (
              ...
              >
                ...
                <td className="px-[10px] py-0 text-center" style={{ verticalAlign: 'middle', fontWeight: 400, fontSize: '14px', lineHeight: '20px', color: '#111827' }}>
                  {row.sent}
                </td>
                <td className="px-[10px] py-0 text-center" style={{ verticalAlign: 'middle', fontWeight: 400, fontSize: '14px', lineHeight: '20px', color: '#111827' }}>
                  {row.replies}
                </td>
                <td className="px-[10px] py-0 text-center" style={{ verticalAlign: 'middle', fontWeight: 400, fontSize: '14px', lineHeight: '16px', color: '#111827', textTransform: 'capitalize' }}>
                  {row.converted}
                </td>
                  ...
                  <div className="relative inline-block text-left">
                    ...
                    {openMenuId === row.id && (
                      <div className="absolute right-0 top-8 z-50 bg-white rounded-xl shadow-lg w-[120px] py-1 overflow-hidden">
                        <button className="block w-full text-left px-4 py-2 hover:bg-[#F9FAFB] cursor-pointer" style={{ fontWeight: 400, fontSize: '14px', lineHeight: '20px', color: '#111827' }}>Edit</button>
                        <button className="block w-full text-left px-4 py-2 hover:bg-[#F9FAFB] cursor-pointer" style={{ fontWeight: 400, fontSize: '14px', lineHeight: '20px', color: '#111827' }}>Pause</button>
                        <button className="block w-full text-left px-4 py-2 hover:bg-[#FFEFEF] cursor-pointer" style={{ fontWeight: 400, fontSize: '14px', lineHeight: '20px', color: '#B91C1C' }}>Delete</button>
                      </div>
                    )}
                  </div>
                </td>
