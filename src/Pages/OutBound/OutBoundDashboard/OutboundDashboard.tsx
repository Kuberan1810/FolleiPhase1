  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
      ...
      <div className="flex flex-col">
        <p className="text-[#004370] mb-2 uppercase font-bold text-[12px] leading-[16px] tracking-[1.2px] font-inter">
          Intelligence Hub
        </p>
        <h1 className="text-[#191C1E] font-[800] text-[34px] leading-tight font-manrope">Outbound Dashboard</h1>
        <p className="text-[#767676] text-[12px] font-semibold leading-none font-inter mt-1.5">Track Your Outreach Performance And Pipeline Generation</p>
      </div>

      {/* Stats Row */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, i) => (
          <div key={i} className="bg-white rounded-[24px] p-6 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F1F5F9] flex flex-col justify-between h-[180px]">
            ...
            <div className="mt-4">
              ...
              <div className="text-[#171C1F] text-[24px] font-[800] leading-[32px] font-manrope">{stat.value}</div>
            </div>
          </div>
        ))}
      </div>
      ...
      <div className="bg-white rounded-[32px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F1F5F9]">
        <div className="flex justify-between items-start mb-10">
          <div>
            <h2 className="text-[#171C1F] text-[20px] font-[800] leading-[28px] font-manrope">Campaign Performance</h2>
            <p className="text-[#64748B] text-[14px] font-inter">Metric comparison across active funnels</p>
          </div>
          <button className="flex items-center gap-2 px-4 py-2 bg-[#F1F5F9] rounded-lg text-[14px] font-manrope font-medium leading-[20px] text-[#191C1E] border border-transparent hover:border-[#E2E8F0] transition-all">
            All Campaign <ChevronDown size={14} />
          </button>
        </div>

        <div className="relative h-[340px] w-full flex flex-col justify-start px-4">
          {/* Y-axis labels */}
        ...
        <div className="flex justify-center gap-6 mt-8">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[11px] font-bold text-[#004370] uppercase">Sent</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-full bg-[#13A26D]"></div>
            <span className="text-[11px] font-bold text-[#13A26D] uppercase">Replied</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-full bg-[#B68E00]"></div>
            <span className="text-[11px] font-bold text-[#B68E00] uppercase">Opened</span>
          </div>
          <div className="flex items-center gap-2">
            <div className="w-2.5 h-2.5 rounded-full bg-[#FFB385]"></div>
            <span className="text-[11px] font-bold text-[#FFB385] uppercase">Booked</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
        ...
        <div className="xl:col-span-8 bg-white rounded-[32px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F1F5F9]">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-[#191C1E] text-[20px] font-bold font-manrope">Target Prospects</h2>
            <button className="bg-[#004370] text-white px-[20px] py-[10px] rounded-[4px] flex items-center gap-[8px] text-[14px] font-bold font-manrope leading-[20px] hover:opacity-90 transition-all">
            ...
            <table className="w-full text-left">
              <thead>
                <tr className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-wider border-b border-[#F1F5F9]">
                  ...
                  <th className="pb-4 font-bold">Persona</th>
                  <th className="pb-4 font-bold">Source</th>
                  <th className="pb-4 font-bold">Status</th>
                  <th className="pb-4 font-bold">Next Action</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-[#F1F5F9]">
                {prospects.map((prospect, i) => (
                  <tr key={i} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="py-5 text-[#464554] font-manrope font-normal text-[14px] leading-[20px]">{prospect.persona}</td>
                    <td className="py-5 text-[#464554] font-manrope font-normal text-[14px] leading-[20px]">{prospect.source}</td>
                    <td className="py-5">
                    ...
                    <td className="py-5 text-[#464554] font-manrope font-normal text-[14px] leading-[20px]">{prospect.action}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      <div className="mt-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-[24px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F1F5F9] flex items-center gap-6">
            <div className="w-[40px] h-[40px] rounded-[12px] bg-[#EFF6FF] flex items-center justify-center text-[#4F46E5] shrink-0">
               <Mail width={25} height={20} strokeWidth={2.5} />
            </div>
          ...
          <div className="bg-white rounded-[24px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F1F5F9] flex items-center gap-6">
            <div className="w-[40px] h-[40px] rounded-[12px] bg-[#ECFDF5] flex items-center justify-center text-[#10B981] shrink-0">
               <MessageSquare width={21} height={21} strokeWidth={2.5} />
            </div>
            <div className="flex-1 min-w-0">
          ...
          {/* Calls Card */}
          <div className="bg-white rounded-[24px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F1F5F9] flex items-center gap-6">
            <div className="w-[40px] h-[40px] rounded-[12px] bg-[#FFF7ED] flex items-center justify-center text-[#F97316] shrink-0">
...
const LiveActivity2 = () => {
  ...
  return (
    <div className="bg-white rounded-[32px] p-8 shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#F1F5F9] h-full">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-[#191C1E] text-[20px] font-bold font-manrope">Live Activity</h2>
      ...
      <div className="space-y-8 relative">
        ...
        {activities.map((act, i) => (
          <div key={i} className="relative pl-6">
            <div className={`absolute left-0 top-1.5 w-[7px] h-[7px] rounded-full ${act.color} z-10 shadow-[0_0_0_3px_white]`}></div>
