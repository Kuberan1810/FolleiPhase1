    ...
    <div className="col-span-12 lg:col-span-5 BoxStyle shadow-[0_4px_20px_rgba(237,243,253,0.4)] flex flex-col justify-between">
      ...
      <div className="space-y-5 flex-1 flex flex-col justify-center">
        {revenueData.map((item) => (
          <div 
            key={item.label} 
            className="flex items-center bg-[#F6F8FF] rounded-[10px] p-2 pl-6 h-[56px] relative cursor-pointer"
          ...
          >
            ...
            <div className="flex-1 h-full flex items-center pr-4">
              <div
                className="h-[46px] rounded-tr-[10px] rounded-br-[10px] transition-all duration-500 hover:opacity-90"
                style={{
                  width: item.width,
