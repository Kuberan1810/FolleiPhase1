        ...
        <div className="w-full overflow-x-auto scrollbar-thin">
          <div className="min-w-[750px] w-full">
            ...
            <div className="grid grid-cols-12 items-center px-5 py-3 bg-[#F3F5FF] border-b border-[#EDF3FD] rounded-t-[10px]">
              <div className="col-span-3 text-[16px] font-semibold text-[#191C1E] text-center">Lead</div>
              <div className="col-span-5 text-[16px] font-semibold text-[#191C1E] text-center">Issue</div>
            ...
            <div className="flex-1">
              {attentionLeads.map((lead, idx) => (
                ...
                >
                  <div className="col-span-3 text-[16px] font-medium text-black leading-[1.2] tracking-[0.6px] text-center truncate">
                    {lead.name}
                  </div>
                  <div className="col-span-5 text-[16px] font-medium text-black leading-[1.2] tracking-[0.6px] truncate pr-2 text-center" title={lead.issue}>
                    {lead.issue}
                  </div>
