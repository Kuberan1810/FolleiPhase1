        ...
        {!isEditing && (
          <div className="relative">
            ...
            <button 
              ...
              className="absolute right-2 top-2 bottom-2 bg-[#004370] text-white px-6 py-2 rounded-[12px] text-[14px] font-medium hover:bg-[#003152] transition-colors shadow-xs cursor-pointer"
            >
              Add Note
            </button>
          </div>
          ...
          {isEditing ? (
            <div className="flex flex-col gap-3">
              <textarea
                ...
                className="w-full bg-white border border-[#EDF3FD] rounded-[12px] p-3 text-[16px] font-medium text-[#475569] focus:outline-none focus:ring-2 focus:ring-[#004370] min-h-[100px] resize-none"
              />
              <div className="flex gap-2 justify-end">
                <button
                  onClick={() => setIsEditing(false)}
                  className="px-4 py-1.5 rounded-[8px] border border-[#EDF3FD] bg-white hover:bg-slate-50 text-[14px] font-semibold text-[#64748B] cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  onClick={handleSave}
                  className="px-4 py-1.5 rounded-[8px] bg-[#004370] hover:bg-[#003152] text-[14px] font-semibold text-white cursor-pointer"
                >
                  Save
                </button>
              </div>
            ...
            <div className="flex flex-col gap-4">
              <div className="flex justify-between items-start gap-4">
                <p className="text-[16px] text-[#475569] font-medium leading-relaxed flex-1">
                  "{noteText}"
                </p>
                <button
                  onClick={() => {
