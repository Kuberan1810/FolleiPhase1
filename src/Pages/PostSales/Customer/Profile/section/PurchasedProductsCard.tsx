    ...
    <div className="bg-white border border-[#EEF0FF] rounded-[20px] p-5 flex flex-col gap-4">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="text-[12px] font-bold text-[#004370] cursor-pointer hover:underline"
        >
          View All
        </button>
      </div>
      ...
      <div className="flex flex-col gap-3">
        {displayedProducts.map((prod, i) => (
          ...
          >
            <div className="flex items-center gap-3">
              <div
                className={`w-9 h-9 rounded-full ${prod.bg} ${prod.color} flex items-center justify-center shrink-0`}
              >
