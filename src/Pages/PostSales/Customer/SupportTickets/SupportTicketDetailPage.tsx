    ...
    <div className="flex flex-col gap-6 w-full font-manrope">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-[20px] sm:text-[24px] font-bold text-[#0D1C2E] truncate">Support & Tickets</h1>
        </div>
      ...
      <div className="bg-white border border-[#EDF3FD] rounded-[16px] shadow-[0_2px_12px_rgba(237,243,253,0.3)] flex flex-col overflow-hidden pb-10">
        ...
        {/* Ticket Title Bar */}
        <div className="bg-[#F8FAFC] px-4 sm:px-6 py-4 flex flex-wrap items-center gap-3 border-b border-[#EDF3FD]">
          <span className="text-[15px] font-semibold text-[#767587]">#{ticket.id}</span>
          <h2 className="text-[15px] sm:text-[16px] font-bold text-[#131B2E] truncate max-w-xs sm:max-w-md">{ticket.title}</h2>
        ...
        {/* Chat Feed */}
        <div className="flex flex-col px-4 md:px-10 pt-8 gap-8">
          ...
          <div className="flex flex-col items-start gap-1 max-w-[90%] sm:max-w-[80%]">
            <div className="flex items-start gap-3 sm:gap-4">
              ...
              <div className="flex flex-col min-w-0">
                <div className="bg-white border border-[#EDF3FD] shadow-sm rounded-tr-[16px] rounded-b-[16px] p-4 sm:p-5 flex flex-col gap-4 max-w-[600px]">
                  ...
                  {/* Attachment Card */}
                  <div className="flex items-center gap-3 p-3 bg-[#FAFBFF] border border-[#EDF3FD] rounded-[8px] w-fit pr-4 sm:pr-8">
                    <div className="w-10 h-10 bg-[#FEF2F2] rounded-[8px] flex items-center justify-center text-[#DC2626] shrink-0">
                      <FileText className="w-5 h-5" />
                    </div>
                    <div className="flex flex-col min-w-0">
                      <span className="text-[13px] font-bold text-[#131B2E] truncate">error_log_04-20.pdf</span>
          ...
          <div className="flex flex-col items-end gap-1 w-full mt-2">
            <div className="flex items-start justify-end gap-3 sm:gap-4 max-w-[90%] sm:max-w-[85%]">
              <div className="flex flex-col min-w-0">
                <div className="bg-[#004370] rounded-tl-[16px] rounded-b-[16px] p-4 sm:p-5 flex flex-col gap-4 shadow-sm max-w-full lg:max-w-[750px] w-full">
                  ...
                  {/* Code block */}
                  <div className="bg-white rounded-[8px] p-4 text-[13px] font-mono leading-relaxed overflow-x-auto max-w-full scrollbar-thin">
                    <div className="text-[#131B2E] whitespace-nowrap">POST /api/v2/auth HTTP/1.1</div>
                    <div className="text-[#131B2E] whitespace-nowrap">Host: api.resolutionos.io</div>
                    <div className="text-[#DC2626] whitespace-nowrap">HTTP/1.1 503 Service Unavailable</div>
                    <div className="text-[#131B2E] whitespace-nowrap">X-Cache-Status: EXPIRED_STALE</div>
                  </div>
                </div>
