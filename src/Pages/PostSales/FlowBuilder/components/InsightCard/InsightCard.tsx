...
const InsightCard: React.FC<InsightCardProps> = ({
  ...
  return (
    <div
      className="bg-white rounded-[10px] p-[15px] border border-[#C1C7D1]/20 w-full max-w-[390px] h-[152px] flex flex-col justify-between group cursor-pointer transition-all font-['Manrope'] shadow-[0_1px_2px_rgba(0,0,0,0.05)] mx-auto md:mx-0 hover:border-[#1D7EBE]/30 hover:shadow-md"
    >
